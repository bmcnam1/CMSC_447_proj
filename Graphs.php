<!-- <html> -->
  <head>
    ...
    <script type="text/javascript">
		...
		// make sure browser can access google charts
		...
		*/
		...
		/*
			update - with new json in data div, this will update all chartc to go off new data
		*/
	    function update() {
		...
		*/
		function drawLineGraph(graph_data, field){
			...
			// add columns for each field value
